        ...
        {tabs.map((item) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center gap-1 py-1 px-3.5 transition-colors relative cursor-pointer group rounded-none"
            >
              ...
              {isActive && (
                <span className="absolute -top-2 left-1/2 -translate-x-1/2 h-[3px] w-[20px] rounded-none bg-primary animate-pulse"></span>
              )}
            </button>
          )
        })}
